...
## Transparent Machine Learning with Visual Analytics: How Interactive Visualization can Support Practitioners in the Machine Learning Process
...
<img src="../assets/inceoglu.png" width="100%" title="Ayhan Inceoglu and Luke Mc Govern: Siemens Power Generation – Big Data Analysis Old World vs. New World"  alt="Ayhan Inceoglu and Luke Mc Govern: Siemens Power Generation – Big Data Analysis Old World vs. New World"/>
...
## Visualizing large-scale geolocation data with kepler.gl
...
## State-of-the-art of Commercial Visual Analytics Systems
...
**SPEAKER BIO**: Dr. Michael Behrisch is a Postdoctoral Researcher with the Visual Computing Group at the Harvard University Cambridge, USA since 2017. 
His research interest include the visualization of relational data, pattern analysis in visualizations, and user-centric exploration approaches for large data spaces. 
He received his PhD. in Computer Science from the University of Konstanz, where he worked from 2011 until 2017 as a Research Associate in the Data Analysis and Visualization Group.
...
## A Primer on Uncertainty Visualization
